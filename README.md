...
## Known issues
* If you want to place the autocomplete inside a `<ScrollView />` make sure to set `keyboardShouldPersistTaps={true}` on the `<ScrollView />` ([#5](https://github.com/l-urence/react-native-autocomplete-input/issues/5)).
